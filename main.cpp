...
void initShaders() {
    ...
    depthMapShader.loadShader("shaders/depth1.vert", "shaders/depth1.frag");
...
void initUniforms() {
    ...
    lightDir = glm::vec3(1.0f, 2.0f, -3.0f);
...
glm::mat4 computeLightSpaceTrMatrix() {
    ...
    glm::mat4 lightSpaceTrMatrix =  lightProjection * lightView * newLightRotation;
